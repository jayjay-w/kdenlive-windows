...
PKG             := knotifications
$(PKG)_VERSION  := 5.23.0
$(PKG)_CHECKSUM  := db310b4e850cfe534a25b5b788914e3b1fb4a22cc1ed210eaf2968498375e68e
$(PKG)_SUBDIR   := $(PKG)-$($(PKG)_VERSION)
$(PKG)_FILE     := $(PKG)-$($(PKG)_VERSION).tar.xz
$(PKG)_HOME     := http://download.kde.org/stable/frameworks
$(PKG)_URL      := $($(PKG)_HOME)/$(basename $($(PKG)_VERSION))/$($(PKG)_FILE)
$(PKG)_DEPS     := qtbase kwindowsystem kservice kconfig kiconthemes kcodecs kcoreaddons phonon
