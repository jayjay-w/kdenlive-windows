...
PKG             := kbookmarks
$(PKG)_VERSION  := 5.23.0
$(PKG)_CHECKSUM  := 74c6452ed80f99ef397e50cd6a488ac58186747090f5462790ccc6c9c0491ccc
$(PKG)_SUBDIR   := $(PKG)-$($(PKG)_VERSION)
$(PKG)_FILE     := $(PKG)-$($(PKG)_VERSION).tar.xz
$(PKG)_HOME     := http://download.kde.org/stable/frameworks
$(PKG)_URL      := $($(PKG)_HOME)/$(basename $($(PKG)_VERSION))/$($(PKG)_FILE)
$(PKG)_DEPS     := qtbase kconfigwidgets kcoreaddons kiconthemes kwidgetsaddons kxmlgui
