...
PKG             := kconfigwidgets
$(PKG)_VERSION  := 5.23.0
$(PKG)_CHECKSUM  := 915eb895a35a71e9e5707ad3d4becc83ee543a27df8293d712374dbd33707872
$(PKG)_SUBDIR   := $(PKG)-$($(PKG)_VERSION)
$(PKG)_FILE     := $(PKG)-$($(PKG)_VERSION).tar.xz
$(PKG)_HOME     := http://download.kde.org/stable/frameworks
$(PKG)_URL      := $($(PKG)_HOME)/$(basename $($(PKG)_VERSION))/$($(PKG)_FILE)
$(PKG)_DEPS     := qtbase kauth kcoreaddons kcodecs kconfig kguiaddons ki18n kwidgetsaddons
